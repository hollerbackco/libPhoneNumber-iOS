Pod::Spec.new do |s|
  ...
  s.version      = "0.5.7.3-hollerbackco"
...
DESC
  s.homepage     = "https://github.com/hollerbackco/libPhoneNumber-iOS"
  s.license      = 'Apache License, Version 2.0 (http://www.apache.org/licenses/LICENSE-2.0)'
  s.authors      = { "iziz" => "zen.isis@gmail.com", "hyukhur" => "hyukhur@gmail.com" }
  s.source       = { :git => "https://github.com/hollerbackco/libPhoneNumber-iOS.git", :tag => "0.5.7.3-hollerbackco" }
  s.platform     = :ios, '4.3'
